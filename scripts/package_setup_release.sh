...
#
# Writes: dist/The-Lost-World-Jurassic-Park-Special-Edition-Recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix The-Lost-World-Jurassic-Park-Special-Edition-Recomp \
  --exe-name The_Lost_World__Jurassic_Park_Special_Edition_Recompiled \
  --display-name "The Lost World: Jurassic Park Special Edition Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned The Lost World: Jurassic Park Special Edition disc" \
