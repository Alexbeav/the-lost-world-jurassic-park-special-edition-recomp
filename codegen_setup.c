...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "the-lost-world-jurassic-park-special-edition-",
    .project_root_env = "THE_LOST_WORLD_JURASSIC_PARK_SPECIAL_EDITION_RECOMP_PROJECT_ROOT",
    .build_dir_env = "THE_LOST_WORLD_JURASSIC_PARK_SPECIAL_EDITION_RECOMP_BUILD_DIR",
    .force_setup_env = "THE_LOST_WORLD_JURASSIC_PARK_SPECIAL_EDITION_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_005.15_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "The_Lost_World__Jurassic_Park_Special_Edition_Recompiled",
    .prepare_note =
