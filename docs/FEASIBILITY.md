...
The supported serial set is `SLUS-00515`. The package uses
...
The corrected source uses `The_Lost_World__Jurassic_Park_Special_Edition_Recompiled` for CMake, the setup relaunch, and packaging.
