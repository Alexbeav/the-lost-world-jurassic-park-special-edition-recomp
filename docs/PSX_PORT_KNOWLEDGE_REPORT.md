# The Lost World: Jurassic Park Special Edition knowledge report

- Date: 2026-08-31
- Retail identity: USA NTSC-U `SLUS-00515`
...
The source now uses `The_Lost_World__Jurassic_Park_Special_Edition_Recompiled` as the only setup executable name. The batch source
